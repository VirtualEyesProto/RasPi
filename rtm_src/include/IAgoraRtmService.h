...
namespace agora {
  namespace rtm {
    ...
    enum ATTRIBUTE_OPERATION_ERR {
        ...
        /**
         4: Attribute size exceeds the limit.
     ...
     enum GET_CHANNEL_MEMBER_COUNT_ERR_CODE {
        ...
        /**
         2: Your channel IDs are invalid, or @p channelCount < 0.
         */
    ...
    struct RtmAttribute
    {
     ...
     public:
        ...
        /**
         ...
         @param value Value of the channel attribute. Must not exceed 8 KB. 
         */
     ...
     struct ChannelAttributeOptions{
        ...
        /**
         ...
         @note This is a one-off flag and hence is valid only within the current method call. 
    ...
    struct PeerOnlineStatus
    {
      ...
      /**
       ...
       - false: The user is offline (the user has not logged in the Agora RTM system).
       */
      bool isOnline;
    };
    ...
    struct ChannelMemberCount
    {
      ...
      /**
       The current channel member count of the channel. 
    ...
    public:
      ...
      /**
       ...
       @note This callback is enabled only when the user, who updates the attributes of the channel, sets \ref agora::rtm::ChannelAttributeOptions::enableNotificationToChannelMembers "enableNotificationToChannelMembers" as true. Also note that this flag is sort of "one-off" and valid only within the channel attribute method call.
...
//         (ATTRIBUTE_OPERATION_ERR) errorCode;
    ...
    /**
     ...
     @return An IRtmChannelAttribute instance.
     */
